...
if(isset($_POST["login"])){
	...
	if(mysqli_num_rows($sql)>0){
		...
		if($pass==$password){
			echo"<script>alert('Login Sucessful'),window.location='hospitalregistration.php';</script>";
			$_SESSION['email']=$row['email'];
      $_SESSION['id']=$row['id'];
		}
		else{
			echo"<script>alert('Invalid Password'),window.location='hospitalregistration.php';</script>";
		}
	}else{
